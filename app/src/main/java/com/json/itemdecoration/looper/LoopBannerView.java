...
public class LoopBannerView extends FrameLayout implements View.OnTouchListener {
    ...
    public LoopBannerView(Context context, @Nullable AttributeSet attrs) {
        ...
        Picasso.with(context).load(R.mipmap.pag1).into(iv_first);
        Picasso.with(context).load(R.mipmap.pag1).into(iv_first_copy);

        Picasso.with(context).load(R.mipmap.pag4).into(iv_last);
        Picasso.with(context).load(R.mipmap.pag4).into(iv_last_copy);

        Picasso.with(context).load(R.mipmap.pag2).into(iv_other1);
        Picasso.with(context).load(R.mipmap.pag3).into(iv_other2);
