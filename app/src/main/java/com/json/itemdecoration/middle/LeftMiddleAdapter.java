 ...
 */
public class LeftMiddleAdapter extends BaseRecyclerViewAdapter<MiddelsItem> {


    public LeftMiddleAdapter(Context context, List<MiddelsItem> data, int layoutId) {
    ...
    protected void onBindData(RecyclerViewHolder holder, MiddelsItem bean, int position) {
        ...
        ((TextView)holder.getView(R.id.tv_left_sell_percent)).setText(bean.getPresentSell());
        ((TextView)holder.getView(R.id.tv_left_buy_percent)).setText(bean.getPresentBuy());
        ((TextView)holder.getView(R.id.tv_left_sell)).setText(bean.getSell());
        ((TextView)holder.getView(R.id.tv_left_buy)).setText(bean.getBuy());
    }
